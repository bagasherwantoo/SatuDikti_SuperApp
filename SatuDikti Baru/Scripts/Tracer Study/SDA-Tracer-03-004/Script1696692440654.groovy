...
Mobile.setText(findTestObject('Object Repository/Tracer Study/Cari Perguruan Tinggi'), 'Universitas Trunojoyo', 0)

Mobile.tap(findTestObject('Tracer Study/Universitas Trunojoyo'), 0)

Mobile.tap(findTestObject('Tracer Study/Button Cari'), 0)

Mobile.tap(findTestObject('Object Repository/Tracer Study/Button Keselarasan Vertikal'), 0)

Mobile.tap(findTestObject('Object Repository/Tracer Study/Button Keselarasan Horizontal'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Tracer Study/Verify/Keselarasan Horizontal'), 0)
