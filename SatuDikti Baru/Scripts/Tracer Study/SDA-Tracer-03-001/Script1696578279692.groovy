...
Mobile.setText(findTestObject('Object Repository/Tracer Study/Cari Perguruan Tinggi'), 'Universitas Indonesia', 0)

Mobile.tap(findTestObject('Object Repository/Tracer Study/Universitas Indonesia'), 0)

Mobile.tap(findTestObject('Tracer Study/Button Cari'), 0)

Mobile.delay(10, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Tracer Study/Verify/Halaman Statistik'), 0)
