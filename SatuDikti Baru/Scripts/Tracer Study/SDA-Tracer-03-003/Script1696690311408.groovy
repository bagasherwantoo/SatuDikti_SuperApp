...
Mobile.setText(findTestObject('Object Repository/Tracer Study/Cari Perguruan Tinggi'), 'Akademi Keperawatan Pemkab Ponorogo', 
    0)

Mobile.tap(findTestObject('Tracer Study/Akkestan Pemkab Ponorogo'), 0)

Mobile.tap(findTestObject('Tracer Study/Button Cari'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Tracer Study/Verify/Halaman Statistik (Blank)'), 0)
