...
Mobile.tap(findTestObject('Object Repository/Tracer Study/Butuh Informasi Lainnya'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Tracer Study/Verify/Halaman FAQ Tracer Study'), 0)
