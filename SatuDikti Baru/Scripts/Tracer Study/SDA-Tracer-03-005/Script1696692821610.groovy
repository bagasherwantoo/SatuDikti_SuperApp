...
Mobile.tap(findTestObject('Tracer Study/Button Keselarasan Vertikal'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Tracer Study/Verify/Keselarasan Vertikal'), 0)
