...
Mobile.tap(findTestObject('Object Repository/Tracer Study/Skip Landing Page'), 0)
...
Mobile.setText(findTestObject('Object Repository/Tracer Study/Cari Perguruan Tinggi'), 'Universitass Indonesiaa', 0)

Mobile.hideKeyboard()

Mobile.verifyElementExist(findTestObject('Object Repository/Tracer Study/Verify/PT Tidak Ditemukan'), 0)
