...
Mobile.swipe(1000, 1200, 0, 1200)

Mobile.tap(findTestObject('Object Repository/Tracer Study/Button Pekerjaan kurang sama 6 bln'), 0)

Mobile.verifyElementExist(findTestObject('Tracer Study/Verify/Data pekerjaan kurang sama 6 bln'), 0)
