...
Mobile.tap(findTestObject('Object Repository/Tracer Study/Pelajari Selengkapnya'), 0)

Mobile.tap(findTestObject('Object Repository/Tracer Study/Kunjungi Website Tracer Study'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Tracer Study/Verify/Website Tracer Study'), 0)
