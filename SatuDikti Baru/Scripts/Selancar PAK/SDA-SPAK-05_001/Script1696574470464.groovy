...
Mobile.tap(findTestObject('Selancar PAK/Lihat Pengajuan Lainnya'), 0)

Mobile.tap(findTestObject('Object Repository/Selancar PAK/Terbit SK'), 0)

Mobile.tap(findTestObject('Selancar PAK/Card detail (terbit SK)'), 0)
