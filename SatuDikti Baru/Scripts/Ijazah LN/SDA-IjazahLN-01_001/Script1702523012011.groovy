...
Mobile.tap(findTestObject('Object Repository/Ijazah LN/Button Pelajari Selangkapnya'), 0)

Mobile.verifyElementExist(findTestObject('Ijazah LN/Verify/Halaman Penjelasan Modul IJazah LN'), 0)
