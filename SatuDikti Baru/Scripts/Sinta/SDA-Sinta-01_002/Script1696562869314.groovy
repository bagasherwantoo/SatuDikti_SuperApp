...
Mobile.tap(findTestObject('Object Repository/Sinta/Pelajari Selengkapnya'), 0)

Mobile.tap(findTestObject('Object Repository/Sinta/Kunjungi Website Sinta'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Sinta/Verify/Website Sinta'), 0)
