...
Mobile.swipe(1000, 1000, 0, 0)

Mobile.swipe(1000, 1000, 0, 0)

Mobile.tap(findTestObject('Object Repository/Sinta/Lihat detail affiliations'), 0)

Mobile.delay(15, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Sinta/Verify/Website affiliattions Gunadarma'), 0)
