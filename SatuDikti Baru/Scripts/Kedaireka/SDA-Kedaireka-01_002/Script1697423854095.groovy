...
Mobile.tap(findTestObject('Object Repository/Kedaireka/Pelajari selengkapmnya'), 0)

Mobile.tap(findTestObject('Object Repository/Kedaireka/Kunjungi website'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Kedaireka/verify/Website Kedaireka'), 0)
