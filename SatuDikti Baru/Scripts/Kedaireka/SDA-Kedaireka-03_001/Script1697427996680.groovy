...
Mobile.tap(findTestObject('Object Repository/Kedaireka/Button daftar sekarang'), 0)

Mobile.delay(4, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Kedaireka/verify/Website kedaireka (Registrasi)'), 0)
