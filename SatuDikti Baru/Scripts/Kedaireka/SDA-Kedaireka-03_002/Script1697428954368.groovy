...
Mobile.swipe(1000, 1000, 1000, 150)

Mobile.tap(findTestObject('Object Repository/Kedaireka/Button lihat FAQ'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Kedaireka/verify/Halaman FAQ kedaireka'), 0)
