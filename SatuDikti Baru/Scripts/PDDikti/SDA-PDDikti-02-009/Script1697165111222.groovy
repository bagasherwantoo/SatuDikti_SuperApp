...
Mobile.setText(findTestObject('PDDikti/Field cari data pada PDDikti'), 'Sistem Informasi\\n', 0)

Mobile.tap(findTestObject('PDDikti/Button Perguruan Tinggi'), 0)

Mobile.tap(findTestObject('PDDikti/Button Dosen'), 0)

Mobile.tap(findTestObject('PDDikti/Button Prodi'), 0)

Mobile.verifyElementExist(findTestObject('PDDikti/Verify/Barr data Sistem Informasi (Prodi)'), 0)
