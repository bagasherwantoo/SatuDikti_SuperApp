...
Mobile.tap(findTestObject('PDDikti/Pelajari Selengkapnya'), 0)

Mobile.tap(findTestObject('Object Repository/PDDikti/Kunjungi Website PDDikti'), 0)

Mobile.delay(6, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/PDDikti/Verify/Website PDDikti'), 0)
