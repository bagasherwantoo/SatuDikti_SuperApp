...
Mobile.setText(findTestObject('PDDikti/Field cari data pada PDDikti'), 'Universitas Gunadarma\\n', 0)

Mobile.tap(findTestObject('Object Repository/PDDikti/Button Perguruan Tinggi'), 0)

Mobile.verifyElementExist(findTestObject('PDDikti/Verify/Barr Universitas Gunadarma (PT)'), 0)
