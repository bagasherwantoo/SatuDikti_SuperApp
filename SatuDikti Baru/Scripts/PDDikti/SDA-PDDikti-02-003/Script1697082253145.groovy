...
Mobile.setText(findTestObject('PDDikti/Field cari data pada PDDikti'), 'Bagas Herwanto\\n', 0)

Mobile.tap(findTestObject('PDDikti/Button Mahasiswa'), 0)

Mobile.verifyElementExist(findTestObject('PDDikti/Verify/Barr data Bagas Herwanto (mhsw)'), 0)
