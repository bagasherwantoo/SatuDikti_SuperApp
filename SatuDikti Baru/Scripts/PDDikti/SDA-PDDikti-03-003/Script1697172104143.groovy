...
Mobile.setText(findTestObject('Object Repository/PDDikti/Cari Provinsi'), 'Jawa Barat\\n', 0)

Mobile.tap(findTestObject('Object Repository/PDDikti/Prov Jawa Barat'), 0)

Mobile.tap(findTestObject('Object Repository/PDDikti/Field PT (Data PT)'), 0)

Mobile.setText(findTestObject('Object Repository/PDDikti/Cari PT (Data PT)'), 'Universitas Pendidikan Indonesia\\n', 0)

Mobile.tap(findTestObject('Object Repository/PDDikti/UPI'), 0)

Mobile.tap(findTestObject('Object Repository/PDDikti/Field Tipe PT'), 0)

Mobile.tap(findTestObject('Object Repository/PDDikti/Tipe PT (Semua)'), 0)

Mobile.tap(findTestObject('PDDikti/Button Cari'), 0)

Mobile.verifyElementExist(findTestObject('PDDikti/Verify/Card hasil pencarian data PT (UPI)'), 0)
